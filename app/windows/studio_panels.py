...
class StudioPanelsMixin:
    def _build_studio_tabs(self):
        ...
        acquisition_layout.addWidget(self._build_connection_group())
        acquisition_layout.addWidget(self._build_scan_group())
        acquisition_layout.addWidget(self._build_workflow_group())
        ...
        results_layout.addWidget(self.create_label("实验会话"))
        results_layout.addWidget(self.session_list)
        results_layout.addWidget(self.create_label("扫描结果"))
        results_layout.addWidget(self.result_list)
        results_layout.addWidget(open_scan_btn)
        results_layout.addWidget(reload_btn)
        results_layout.addWidget(self.create_label("结果详情"))
        results_layout.addWidget(self.result_detail_text)
        ...
        self.tab_widget.addTab(acquisition_tab, "采集控制")
        self.tab_widget.addTab(results_tab, "结果中心")
