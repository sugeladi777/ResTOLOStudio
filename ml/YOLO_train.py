...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        #state_dict = ckpt.float().state_dict()  # to FP32
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser() #中断需要下面第一行更改路径：'runs/temporary_yolov5m.pt'
    parser.add_argument('--weights', type=str, default='weights/yolov5m.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/yolov5m_molecule.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/molecule.yaml', help='data.yaml path')
